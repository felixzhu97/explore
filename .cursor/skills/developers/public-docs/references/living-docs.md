...
| New/changed cross-BC runtime or contract edge | OpenAPI in `packages/contracts-*` + ACL; platform/app Dynamic as needed — [cross-context-integration](cross-context-integration.md) | **1** terms; **2–3** contract + C4 |
