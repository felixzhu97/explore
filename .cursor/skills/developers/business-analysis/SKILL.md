...
6. **Handoff** — deliver Glossary term draft + `C4-Code-Domain-Model.puml` update suggestions to developer **before** implementation; PO for Jira stories / AC; do not invent ferry specs.
...
- [ ] Domain model draft + Glossary ready **before** developer codes (or N/A)
