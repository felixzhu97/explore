...
- [ ] **Linked to an Epic** (Epic key recorded; create Epic first if none matches)

Detail: [acceptance-criteria.md](acceptance-criteria.md) | [story-points.md](story-points.md) | [mcp.md](mcp.md)
