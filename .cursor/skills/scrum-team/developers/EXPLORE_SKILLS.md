# Explore-AI skills (global)

Moved from `explore-ai/.cursor/skills`. Live under this Developers role folder.

| Skill | Path |
|-------|------|
| [developer](./developer/) | XP / DDD / BDD / TDD / Commit·PR |
| [business-analysis](./business-analysis/) | Business Analysis |
| [market-tech-analysis](./market-tech-analysis/) | Market + tech strategy |
