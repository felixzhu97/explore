...
| [Explore ML](https://github.com/felixzhu97/explore-ml) | C4 | [`explore-ml/docs/developer/c4-model/`](explore-ml/docs/developer/c4-model/) | Optional Python FastAPI helpers: recommendation, vision, RAG, media-gen |
